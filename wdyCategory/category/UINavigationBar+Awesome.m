//
//  UINavigationBar+OrderList.m
//  ZhuanMCH
//
//  Created by txooo on 16/9/8.
...
static char UINavigationBar_AwesomeOverlayKey;

- (UIView *)overlay {
    return objc_getAssociatedObject(self, &UINavigationBar_AwesomeOverlayKey);
}

- (void)setOverlay:(UIView *)overlay {
    objc_setAssociatedObject(self, &UINavigationBar_AwesomeOverlayKey, overlay, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
